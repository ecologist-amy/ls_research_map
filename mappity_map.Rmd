...
ba3 <- ba2 %>% 
  add_row(Location = "Global Trends", lat = "120.00000", long = "15", abiotic = 68, biotic = 21, both = 13, total = 102, radius = 22, groups = ">29", )
...
eco3 <- eco2 %>%
  add_row(Location = "Global Trends", lat = "108.00000", long = "15", all = 40, fre_mar = 10, ter_fre = 38, ter_mar = 14, total = 102, radius = 22, groups = ">29", )
